...
-- Premium: базовая цена включает 4 устройства, выбор доступен до 8.
-- Доплаты подобраны так, чтобы итог за 8 устройств совпадал с Premium 8.
UPDATE plans SET max_device_limit = 8 WHERE name = 'Premium';
